...
class GalleryFragment3ViewModel : ViewModel() {
    fun Caranta(c: String, a: String, r: String, a2: String, n: String, t: String, a3: String): Boolean {
    ...
    fun RodriguezM(r: String, o: String, d: String, r2: String, i: String, g: String, u: String, e: String, z: String): Boolean {
    ...
    fun RodriguezC(r: String, o: String, d: String, r2: String, i: String, g: String, u: String, e: String, z: String): Boolean {
        return r.equals("R", ignoreCase = true) &&
                o.equals("O", ignoreCase = true) &&
                d.equals("D", ignoreCase = true) &&
                r2.equals("R", ignoreCase = true) &&
    ...
    fun Ledesma(l: String, e: String, d: String, e2: String, s: String, m: String, a: String): Boolean {
    ...
    fun Cardozo(c: String, a: String, r: String, d: String, o: String, z: String, o2: String): Boolean {
        return c.equals("C", ignoreCase = true) &&
                a.equals("A", ignoreCase = true) &&
                r.equals("R", ignoreCase = true) &&
                d.equals("D", ignoreCase = true) &&
    ...
    fun Riquelme(r: String, i: String, q: String, u: String, e: String, l: String, m: String, e2: String): Boolean {
        return r.equals("R", ignoreCase = true) &&
                i.equals("I", ignoreCase = true) &&
    ...
    fun Palacio(p: String, a: String, l: String, a2: String, c: String, i: String, o: String): Boolean {
    ...
    fun Palermo(p: String, a: String, l: String, e: String, r: String, m: String, o: String): Boolean {
        return p.equals("P", ignoreCase = true) &&
                a.equals("A", ignoreCase = true) &&
                l.equals("L", ignoreCase = true) &&
                e.equals("E", ignoreCase = true) &&
